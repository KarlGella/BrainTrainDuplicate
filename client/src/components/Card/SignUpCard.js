...
const SignUpCard = () => {
  ...
  const onRegisterSubmit = () => {
    if (check == false) {
      selectStatement("Please agree on our terms and privacy");
    } else if (
      firstName === "" ||
      lastName === "" ||
      email === "" ||
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Brain Train.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Brain Train, accessible
                      from{" "}
                      <a
